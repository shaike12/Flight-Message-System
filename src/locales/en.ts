export const en = {
  ...
  flightForm: {
    ...
    newTime: 'New Time',
    originalTimeHelper: 'Enter the departure time shown in PNR',
    newTimeHelper: 'Enter the new departure time received in message (UTC)',
    localTime: 'Local Time (Now)',
    localDate: 'Local Date (Now)',
    localTimeDeparture: 'Local Time after decoding (Departure)',
    utcTime: 'UTC Time',
    utcOf: 'of',
    originalTimeLabel: 'Original Departure Time',
    newTimeLabel: 'New Departure Time (UTC)',
    text: 'Text',
    time: 'Time',
    date: 'Date',
    number: 'Number',
    originalDate: 'Original Departure Date',
    newDate: 'New Departure Date',
    ...
    flightNumberHelper: 'Enter flight number up to 4 digits',
    datePicker: {
      today: 'Today',
      tomorrow: 'Tomorrow',
      year: 'Year',
  ...
  templateManager: {
    ...
    frenchContent: 'Template Content - French',
    ...
    frenchContentLabel: 'French Content:',
    active: 'Active',
    inactive: 'Inactive',
  ...
  csvPhoneNumbers: {
    ...
    invalidPhoneNumbers: 'Invalid phone numbers found',
    totalInvalidNumbers: 'Total invalid numbers'
  }
};
