export const en = {
  ...
  flightForm: {
    ...
    newTime: 'New Time',
    originalTimeHelper: 'Enter the departure time received in the PNR',
    newTimeHelper: 'Enter the new departure time received in Email (UTC)',
    localTime: 'Local Time',
    localDate: 'Local Date',
    localTimeDeparture: 'Local Time (Departure)',
    utcTime: 'UTC Time',
    utcOf: 'UTC of',
    originalTimeLabel: 'Original Time (UTC) - Departure',
    newTimeLabel: 'New Time (UTC) - Departure',
    text: 'Text',
    time: 'Time',
    date: 'Date',
    number: 'Number',
